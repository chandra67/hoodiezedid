...
$bg_item = ($crop_width-$adjusted_width)/2;

if($adjusted_width>$crop_width){
    imagecopyresampled($cropped_image_gd ,$original_image_gd ,$int_width,-$int_height,0,0, $crop_width, $adjusted_height, $original_width , $original_height );
}else{
    imagecopyresampled($cropped_image_gd ,$original_image_gd ,$bg_item,0,0,0, $adjusted_width, $crop_height, $original_width , $original_height );
}
