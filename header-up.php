    ...
    if(isset($_SESSION["cart_item"])){
        ...
        $isicart = $salesproduct->cekRowPerSales();
                ...
                ?>
                            ...
                            <a onmouseover="showDropDown();" onmouseout="hideDropDown();" id="hover" href="##"><?php echo $_SESSION['customerName']; ?>!</a><p>Welcome</p>
        ...
        <div class="header-sub-nav" onmouseover="showDropDown();" onmouseout="hideDropDown();" id="dropdown" >
              ...
              <div class="sub-button"  onclick="document.location = '../account-setting.php';">Confirmation</div>
              <div class="sub-button"  onclick="document.location = '../account-setting.php';">Hystory</div>
