...
<html>
    <head>
        <?php
         if($articlepage){
        ?>
         <title>dbora <?php echo ":: ".$news->newsTitle; ?></title>
    ...
    if(isset($_SESSION["cart_item"])){
        ...
        $isicart = $salesproduct->cekRowPerSales();
                ...
                ?>
                           ...
                           <a onmouseover="showDropDown();" onmouseout="hideDropDown();" id="hover" href="##"><?php echo $_SESSION['customerName']; ?></a> 
                ...
                <?php
                            ...
                            <a href="cart/cart.php" class="cart"><b><?php echo  $isicart; ?></b></a>
                             ...
                             <a href="signup.php" <?php if ($current == 'Register') {
                                 echo "class=\"current\"";
                             } ?> >Register</a><a href="signin.php" <?php if ($current == 'Login') {
                                 echo "class=\"current\"";
                             } ?> >Login</a>
         ...
         <div class="header-sub-nav" onmouseover="showDropDown();" onmouseout="hideDropDown();" id="dropdown" >
              ...
              <div class="sub-button"  onclick="document.location = 'history.php';">History</div>
