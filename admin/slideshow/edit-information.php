<?php
    ...
    ?>
                        ...
                        <h3>Edit Slideshow Information</h3>
                        <p><small><a href="slideshow.php">Manage Slideshow</a> > <a href="##">Edit Slideshow Information</a></small></p><br>
                        <p><img src="crop.php?h=180&w=400&f=../uploaded_images/<?php echo $image->imageType."/".$image->imageHeaderId."/".$image->imageUrl; ?>" /></p>
                 <form name="editProduct" action='slideshow/update-information.php' method="post" enctype='multipart/form-data'>
                     <table cellpadding="3">
