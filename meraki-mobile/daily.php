...
?>
                        ...
                        <div class="news-img" style="background-image: url(http://meraki.co.id/uploaded_images/news<?php echo "/".$newsView[$i]->idNews."/".$newsView[$i]->newsImage; ?>); background-position: center top;">
                        </div>
